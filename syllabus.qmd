...
| Dia 03| Aula teórica 4: tópicos avançados em programação no R (controle de fluxo, repetições e funções) |
| Dia 03| Aula prática 2: integração entre R e git/GitHub em trabalho científicos    |
| Dia 04| Projeto prático: desenvolvimento de uma análise ecológica reprodutível usando R e git/GitHub |
| Dia 04| Projeto prático: apresentação dos projetos                                |
| Dia 04| Discussão: reprodutibilidade na ciência e desafios no uso de R e git/GitHub para ecologia |
